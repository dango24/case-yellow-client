 ...
 */
public class AppBootInitializerTest {
    ...
    public void bootAppWithArgs() throws Exception {
        ...
        Method buildArgsKeyValueParisMethod = AppBootInitializer.class.getDeclaredMethod("buildArgsKeyValueParis", String[].class);
    ...
    private void createDefaultLoggingDir() throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        Method createDefaultLoggingFileMethod = AppBootInitializer.class.getDeclaredMethod("createDefaultLoggingFile");
